  ...
  public static void main(String[] args) {
    ...
    JPanel renderPanel = new JPanel() {
      ...
      public void paintComponent(Graphics g) {
        ...
        /*
         * for(int i = 0; i < getWidth(); i++) { if(i*edgeWidth > getWidth()) { break; }
         * Vertex v = new Vertex(0 + (i*edgeWidth), bottom, 0); Edge ed = new
         * Edge(horizon, v); verticalEdges.add(ed); ed.drawLine(g2); }
         */
        ...
        for (int i = 0; i < intersectionsL.size() - 1; i++) {
          Tile tile = new Tile(intersectionsL.get(i), intersectionsL.get(i + 1), intersectionsR.get(i),
              intersectionsR.get(i + 1), Color.DARK_GRAY);
          tiles.add(tile);
