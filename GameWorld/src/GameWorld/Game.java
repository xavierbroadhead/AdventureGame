...
public class Game {
  ...
  public Game(Player player) {
    ...
    Position[][] map1 = { { new Position(0, 0), null, new Position(2, 0), new Position(3, 0), null },
        ...
        { new Position(0, 2), new Position(1, 2), new Position(2, 2), null, null }, { null, null, null, null, null },
        { null, null, null, null, null } };

    Position[][] map2 = { { new Position(0, 0), null, null, null, null },
        { new Position(0, 1), null, null, null, null }, { new Position(0, 2), new Position(1, 2), null, null, null },
    ...
    Key key2 = new Key(1, map2[2][4], 2, "Its a key. You notice the letter Z inscribed on it.", "Key", 2, door3,
        new ImageIcon());
  ...
  /**
   * Takes in an array of Positions, returns a 5x5 2D array of Positions correctly
   * ordered as a map.
   * 
   * 
   * @param pos
   *          - Array of Positions we want to convert to a map
   * @return - 2D array of Positions
   */
  public Position[][] positionsToMap(Position[] pos) {
    Position[][] buffer = { { null, null, null, null, null }, { null, null, null, null, null },
        { null, null, null, null, null }, { null, null, null, null, null }, { null, null, null, null, null } };
    for (Position p : pos) {
      if (buffer[p.getx()][p.gety()] == null)
        buffer[p.getx()][p.gety()] = p;
    }
    return buffer;
  }

  /**
   * Checks how many tiles from player's current position and current direction
   * until they hit a wall
   * 
   * 
   * @return integer representing number of tiles directly in front of player
  ...
  /**
   * Check if there is a left corner in front of our current position within our
   * vision.
   * 
   * 
   * @return - true if there is a left corner in front of player's current
  ...
  /**
   * Check if there is a corner to the right of our current position within our
   * vision.
   * 
   * 
   * @return - true if there is a right corner in front of the player's current
   *         position and direction.
   */
